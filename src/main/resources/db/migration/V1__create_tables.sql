...
CREATE TABLE ${db.prefix}.INSPECTION_TYPE
(
    INSPECTION_TYPE_ID SMALLSERIAL,
...
(
    ...
    INSPECTION_VALUE_TYPE_ID VARCHAR NOT NULL,
    CREATED_AT TIMESTAMP NULL,
    UPDATED_AT TIMESTAMP NULL,
    PRIMARY KEY (VEHICLE_INSPECTION_ID),
    CONSTRAINT fk_vehicle FOREIGN KEY (VEHICLE_ID) REFERENCES ${db.prefix}.VEHICLE(VEHICLE_ID),
    CONSTRAINT fk_inspection_type FOREIGN KEY (INSPECTION_TYPE_ID)
        REFERENCES ${db.prefix}.INSPECTION_TYPE(INSPECTION_TYPE_ID),
    CONSTRAINT fk_inspection_value_type FOREIGN KEY (INSPECTION_VALUE_TYPE_ID)
...
INSERT INTO ${db.prefix}.INSPECTION_TYPE (INSPECTION_TYPE)
